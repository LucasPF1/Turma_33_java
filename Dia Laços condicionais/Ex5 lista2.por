...
programa{	
		...
		índice de agrupamento mantém 3 grupos de indústrias 
		que são altamente poluentes do meio ambiente.
		O índice de tolerância aceitável varia de 0,05 até 0,25.
		...
		Faça um sistema que leia o índice de índice medido e emita uma notificação adequada aos diferentes 
		grupos de empresas.Índice aceitável
		0,5 todos fechem agora0,4 1 e 2 fecha agora
		0.3 grupo 1 fecha agora0,25
		*/
	funcao inicio ()
	{
	// variáveis	
	...
	// entrada-
		...
		escreva ("Por favor, informe o seu índice de índice! \n")
		leia (ipa)
