...
   Cálculo o quadrado de cada um;
   Se o valor resultante do quadrado do terceiro for> = 1000, imprima-o e finalize;
   Caso contrário, imprima os valores lidos e seus únicos quadrados.*/
	...
	// variaveis
		...
		n2 real
		real n3
		qn3 real // variável para guardar o quadrado do n3
		n4 real
	...
	// processamento e saida juntos
		...
		se (qn3> = 1000) // se o resultado do quadrado de n3 para maior que 1000 então ...
		{
			escreva ("O valor do n3 é:" + qn3 + "\nprograma finalizado !! \n")
		}
		senao // caso contrário, norma todos os valores e seus quadrados, bonitinho
		{
